...
dir.create(here("graphs", "07-simulate-model-savings"), showWarnings = FALSE)
dir.create(here("work", "07-simulate-model-savings"), showWarnings = FALSE)
...
write_rds(data_simul_tabul,   here("work", "07-simulate-model-savings", "data_simul_savings_tabul.rds"))
write_rds(data_simul_effects, here("work", "07-simulate-model-savings", "data_simul_savings_effects.rds"))
...
data_simul_savings_tabul   <- read_rds(here("work", "07-simulate-model-savings", "data_simul_savings_tabul.rds"))
data_simul_savings_effects <- read_rds(here("work", "07-simulate-model-savings", "data_simul_savings_effects.rds"))
...
tabulations_combined <- bind_rows(
    ...
    data_simul_savings_tabul %>% mutate(type = "Simulated\n(counterfactual)"),
...
pdf(here("graphs", "07-simulate-model-savings", "actual-simul-top1-savings.pdf"), height = 3, width = 4)
print(
    tabulations_combined %>%
        ...
        annotate("segment", x = 2030, xend = 2050, y = 0.45, yend = 0.29,
            color = "#F26419", arrow = arrow(length = unit(0.20, "cm"), ends = "last", type = "open")) +
        annotate("richtext", x = 2010, y = 0.475,
            label = "With <strong>1962-1978 saving rates</strong>,<br>the <strong>top 1% share</strong> would be<br><strong>~9pp. lower</strong> in the long run",
            color = "#F26419",
            size = 3,
            fill = NA,
            label.color = NA) +
