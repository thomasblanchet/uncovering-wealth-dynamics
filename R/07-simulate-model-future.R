...
dir.create(here("graphs", "07-simulate-model-future"), showWarnings = FALSE)
dir.create(here("work", "07-simulate-model-future"), showWarnings = FALSE)
...
write_rds(data_simul_tabul,   here("work", "07-simulate-model-future", "data_simul_future_tabul.rds"))
write_rds(data_simul_effects, here("work", "07-simulate-model-future", "data_simul_future_effects.rds"))
...
pdf(here("graphs", "07-simulate-model-future", "actual-simul-top1-future.pdf"), height = 3.5, width = 3.5)
print(
    tabulations_combined %>%
        ...
        annotate("text", label = "Observed", x = 1928, y = 0.25, color = "#2F4858") +
        annotate("segment", x = 1930, xend = 1943, y = 0.26, yend = 0.31, color = "#2F4858",
        ...
        annotate("segment", x = 2025, xend = 2035, y = 0.425, yend = 0.38, color = "#F26419",
            arrow = arrow(length = unit(0.20, "cm"), ends = "last", type = "open")) +

        scale_color_manual(values = c(`Observed` = "#2F4858", `Simulated\n(benchmark)` = "#F26419", `Simulated\n(counterfactual)` = "#F26419")) +
        ...
        scale_x_continuous(name = "year", limits = c(1910, 2070), breaks = seq(1920, 2060, 20), minor_breaks = NULL) +
